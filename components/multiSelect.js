...
const MultiSelect = props => {
  const fieldName = props.fieldName;
    ...
    <div className='items-center justify-start pl-8 flex'>
        <div className="flex tags-input w-4/5 min-h-max rounded-md max-w-screen-md max-h-14 px-2 focus:ring-1 border-2 hover:border-blue-500 active: outline-blue-500 box-border overflow-scroll hover:xs"> 
      ...
      <div className='p-2'><button className="bg-blue-700 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded"> Add </button>
      </div>
      </div>
    </div>
